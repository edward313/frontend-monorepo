...
const MINUTE_OPTIONS_COUNT = 12;
const SECONDS_IN_MINUTE = 60;
const START_MONTH_FALLBACK = new Date("1970-02-01");
...
const DatePicker = ({
	...
	const hours = Array.from({ length: HOURS_IN_DAY }, (_, i) => i); // 0-23 giờ
	const minutes = Array.from(
		{ length: MINUTE_OPTIONS_COUNT },
		(_, i) => i * MINUTES_STEP,
	); // 0, 5, 10, ..., 55 phút
	const seconds = Array.from({ length: SECONDS_IN_MINUTE }, (_, i) => i); // 0, 5, 10, ..., 55 giây
			...
			<PopoverContent className="w-auto p-0" align="start">
				<div className="sm:flex">
					<Calendar
						...
						startMonth={slotPropsCalendar?.startMonth || START_MONTH_FALLBACK}
