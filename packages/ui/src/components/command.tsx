...
function CommandItem({
	...
	return (
		<CommandPrimitive.Item
			...
			className={cn(
				"relative flex cursor-default items-center gap-3 rounded-md px-2 py-1.5 text-sm outline-hidden select-none mb-1 last:mb-0 [&_svg]:pointer-events-none [&_svg]:shrink-0",
				"data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50",
				"hover:bg-gray-100",
				"data-[item-selected=true]:bg-blue-100 data-[item-selected=true]:text-blue-700",
