...
function SidebarTrigger({
	...
	const { toggleSidebar, open, isTablet } = useSidebar();
	...
	return (
		<Button
			...
			size="icon"
			className={cn(
				"size-8 bg-white text-foreground rounded-md lg:rounded-full shadow-sm hover:bg-white",
				className,
			)}
			onClick={(event) => {
				onClick?.(event);
...
function SidebarGroupLabel({
	...
	return (
		<Comp
			...
			className={cn(
				"text-sidebar-foreground/70 ring-sidebar-ring flex h-10 shrink-0 items-center rounded-md px-2 text-sm font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:shrink-0",
				"group-data-[collapsible=icon]:-mt-10 group-data-[collapsible=icon]:opacity-0 group-data-[collapsible=icon]:-z-10",
				className,
			)}
			{...props}
		/>
...
function SidebarGroupAction({
	...
	return (
		<Comp
			...
			className={cn(
				"text-sidebar-foreground ring-sidebar-ring hover:text-sidebar-accent-foreground absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:shrink-0",
...
function SidebarMenuAction({
	...
	return (
		<Comp
			...
			className={cn(
				"text-sidebar-foreground ring-sidebar-ring hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:shrink-0",
				// Increases the hit area of the button on mobile.
				"after:absolute after:-inset-2 md:after:hidden",
